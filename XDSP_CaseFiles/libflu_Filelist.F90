################################################################################
#
# $Id: Filelist.txt,v 1.2 2015/07/27 04:45:41 brollin Exp $
#
...
SRCF90+=        RFLU_AllocateMemoryTbc.F90\
		...
		RFLU_CloseRestartInfo.F90\
                ...
                RFLU_ComputeGridSpacingCyldet.F90\
		RFLU_ComputeGridSpacingShktb.F90\
		RFLU_ComputeGridSpacingXdsp.F90\
                RFLU_CreateGrid.F90\
		RFLU_CreateRegions.F90\
                RFLU_DecideNeedBGradFace.F90\
                RFLU_DecideNeedStencils.F90\
                RFLU_DecideNeedWeights.F90\
		RFLU_DecidePrint.F90\
		RFLU_DecideWrite.F90\
                RFLU_DecideSmallWrite.F90\
                RFLU_DerivedInputValues.F90\
                RFLU_DestroyGrid.F90\
                RFLU_EnforceBounds.F90\
		RFLU_EnforceBoundsWrapper.F90\
		RFLU_EquilibriumEulerian.F90\
		RFLU_FinishSD.F90\
		RFLU_GetCvLoc.F90\
                RFLU_GetUserInput.F90\
                RFLU_InitAuxVars.F90\
                RFLU_InitGlobal.F90\
...
#
# $Log: Filelist.txt,v $
# Revision 1.2  2015/07/27 04:45:41  brollin
...
# New Stable version
#
# Revision 1.3  2009/07/08 19:11:16  mparmar
# Added RFLU_InitAuxVars.F90
#
# Revision 1.2  2007/11/28 23:04:30  mparmar
# Added RFLU_DecideNeedStencils.F90 and RFLU_DecideNeedWeights.F90
#
